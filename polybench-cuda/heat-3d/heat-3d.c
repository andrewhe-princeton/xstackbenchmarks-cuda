  ...
  for (int t = 1; t <= tsteps; t++) {
    for (int i = 1; i < n - 1; i++) {
      for (int j = 1; j < n - 1; j++) {
        for (int k = 1; k < n - 1; k++)
          B[(i * n + j) * n + k] =
              (A[((i + 1) * n + j) * n + k] - 2 * A[(i * n + j) * n + k] +
               A[((i - 1) * n + j) * n + k]) /
                  8 +
              (A[(i * n + (j + 1)) * n + k] - 2 * A[(i * n + j) * n + k] +
               A[(i * n + (j - 1)) * n + k]) /
                  8 +
              (A[(i * n + j) * n + k + 1] - 2 * A[(i * n + j) * n + k] +
               A[(i * n + j) * n + k - 1]) /
                  8 +
              A[(i * n + j) * n + k];
      }
    ...
    for (int i = 1; i < n - 1; i++) {
      for (int j = 1; j < n - 1; j++) {
        for (int k = 1; k < n - 1; k++)
          A[(i * n + j) * n + k] =
              (B[((i + 1) * n + j) * n + k] - 2 * B[(i * n + j) * n + k] +
               B[((i - 1) * n + j) * n + k]) /
                  8 +
              (B[(i * n + (j + 1)) * n + k] - 2 * B[(i * n + j) * n + k] +
               B[(i * n + (j - 1)) * n + k]) /
                  8 +
              (B[(i * n + j) * n + k + 1] - 2 * B[(i * n + j) * n + k] +
               B[(i * n + j) * n + k - 1]) /
                  8 +
              B[(i * n + j) * n + k];
      }
