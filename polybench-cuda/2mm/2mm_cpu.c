...
int main(int argc, char **argv) {
  ...
  _ZL10init_arrayiiiiPdS_S_S_S_(call2, call4, call7, call10, ((double *)A),
                                ((double *)B), ((double *)C), ((double *)D),
                                ((double *)tmp));
  ;
  _ZL6kerneliiiiddPdS_S_S_S_(call2, call4, call7, call10, 32412, 2123,
...
void _ZL6kerneliiiiddPdS_S_S_S_(uint32_t ni, uint32_t nj, uint32_t nk,
  ...
  memcpy(((uint8_t *)(&agg_2e_tmp7_2e_coerce)), ((uint8_t *)(&agg_2e_tmp7)),
         12);
#pragma omp parallel for collapse(2)
      ...
      for (int32_t k = 0; k < 8; k = k + 1) {
        ...
        for (int32_t l = 0; l < 32; l = l + 1) {
          _Z14kernel_A_mul_BiiiiddPdS_S_S_S__OC_1(
              ni, nj, nk, nl, alpha, beta, tmp, A, B, C, D, call, call5, 1, div,
              32, 1, i, j, 0, k, l, 0);
        }
      }
    }
  ...
  memcpy(((uint8_t *)(&agg_2e_tmp20_2e_coerce)), ((uint8_t *)(&agg_2e_tmp20)),
         12);
  memcpy(((uint8_t *)(&agg_2e_tmp21_2e_coerce)), ((uint8_t *)(&agg_2e_tmp21)),
         12);
#pragma omp parallel for collapse(2)
      ...
      for (int32_t k = 0; k < 8; k = k + 1) {
        ...
        for (int32_t l = 0; l < 32; l = l + 1) {
          _Z23kernel_D_plus_tmp_mul_CiiiiddPdS_S_S_S__OC_2(
              ni, nj, nk, nl, alpha, beta, tmp, A, B, C, D, call13, call18, 1,
              div, 32, 1, i, j, 0, k, l, 0);
        }
      }
    }
  }
...
void _Z14kernel_A_mul_BiiiiddPdS_S_S_S__OC_1(
    ...
    uint32_t gridDim_2e_x, uint32_t gridDim_2e_y, uint32_t gridDim_2e_z,
    uint32_t blockDim_2e_x, uint32_t blockDim_2e_y, uint32_t blockDim_2e_z,
    uint32_t blockIdx_2e_x, uint32_t blockIdx_2e_y, uint32_t blockIdx_2e_z,
    uint32_t threadIdx_2e_x, uint32_t threadIdx_2e_y, uint32_t threadIdx_2e_z) {
  int32_t i;
  int32_t j;
  int64_t k;
  double dot;
