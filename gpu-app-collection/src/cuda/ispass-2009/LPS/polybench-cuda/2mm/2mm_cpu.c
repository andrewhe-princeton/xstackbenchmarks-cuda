...
int16_t _Z10num_blocksss(int16_t, int16_t)
    __ATTRIBUTELIST__((noinline, nothrow));
int main(int, char **) __ATTRIBUTELIST__((noinline));
void _ZL10init_arrayiiiiPdS_S_S_S_(uint32_t, uint32_t, uint32_t, uint32_t,
                                   double *, double *, double *, double *,
                                   double *)
    __ATTRIBUTELIST__((noinline, nothrow));
uint32_t cudaMemcpy(uint8_t *, uint8_t *, uint64_t, uint32_t);
void _ZL6kerneliiiiddPdS_S_S_S_(uint32_t, uint32_t, uint32_t, uint32_t, double,
                                double, double *, double *, double *, double *,
                                double *) __ATTRIBUTELIST__((noinline));
...
void _Z14kernel_A_mul_BiiiiddPdS_S_S_S__OC_1(
    uint32_t, uint32_t, uint32_t, uint32_t, double, double, double *, double *,
    double *, double *, double *, uint32_t, uint32_t, uint32_t, uint32_t,
    uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t,
    uint32_t) __ATTRIBUTELIST__((noinline, nothrow));
void _Z23kernel_D_plus_tmp_mul_CiiiiddPdS_S_S_S__OC_2(
    uint32_t, uint32_t, uint32_t, uint32_t, double, double, double *, double *,
    double *, double *, double *, uint32_t, uint32_t, uint32_t, uint32_t,
    uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t,
    uint32_t) __ATTRIBUTELIST__((noinline, nothrow));
...
int main(int argc, char **argv) {
  ...
  _ZL10init_arrayiiiiPdS_S_S_S_(__FIXME__call2, __FIXME__call4, __FIXME__call7,
                                __FIXME__call10, ((double *)A), ((double *)B),
                                ((double *)C), ((double *)D), ((double *)tmp));
  ;
  _ZL6kerneliiiiddPdS_S_S_S_(__FIXME__call2, __FIXME__call4, __FIXME__call7,
                             __FIXME__call10, 32412, 2123, ((double *)tmp),
...
void _ZL10init_arrayiiiiPdS_S_S_S_(uint32_t ni, uint32_t nj, uint32_t nk,
                                   uint32_t nl, double *A, double *B, double *C,
                                   double *D, double *tmp) {
  int64_t i;
  int64_t j;
  // YEBIN: this point in function printer
...
void _ZL6kerneliiiiddPdS_S_S_S_(uint32_t ni, uint32_t nj, uint32_t nk,
                                uint32_t nl, double alpha, double beta,
                                double *tmp, double *A, double *B, double *C,
                                double *D) {
  ...
  struct __FIXME__l_struct_struct_OC_dim3
      __FIXME__agg_2e_tmp7; /* Address-exposed local */
  struct __FIXME__l_unnamed_1
      __FIXME__agg_2e_tmp_2e_coerce; /* Address-exposed local */
  struct __FIXME__l_unnamed_1
      __FIXME__agg_2e_tmp7_2e_coerce; /* Address-exposed local */
  struct __FIXME__l_struct_struct_OC_dim3
      __FIXME__agg_2e_tmp20; /* Address-exposed local */
  struct __FIXME__l_struct_struct_OC_dim3
      __FIXME__agg_2e_tmp21; /* Address-exposed local */
  struct __FIXME__l_unnamed_1
      __FIXME__agg_2e_tmp20_2e_coerce; /* Address-exposed local */
  struct __FIXME__l_unnamed_1
      __FIXME__agg_2e_tmp21_2e_coerce; /* Address-exposed local */
  ...
  __FIXME__call =
      _Z10num_blocksss(ni, block.__FIXME__l_struct_struct_OC_dim3_field0);
  __FIXME__call5 =
      _Z10num_blocksss(nj, block.__FIXME__l_struct_struct_OC_dim3_field1);
  ...
  memcpy(((uint8_t *)(&__FIXME__agg_2e_tmp7_2e_coerce)),
         ((uint8_t *)(&__FIXME__agg_2e_tmp7)), 12);
#pragma omp parallel for collapse(2)
    ...
    for (int32_t j = 0; j < __FIXME__call5; j = j + 1) {
      ...
      for (int32_t k = 0; k < 8; k = k + 1) {
        ...
        for (int32_t l = 0; l < 32; l = l + 1) {
          _Z14kernel_A_mul_BiiiiddPdS_S_S_S__OC_1(
              ni, nj, nk, nl, alpha, beta, tmp, A, B, C, D, __FIXME__call,
              __FIXME__call5, 1, __FIXME__div, 32, 1, i, j, 0, k, l, 0);
        }
      }
    }
  }
  __FIXME__call13 =
      _Z10num_blocksss(ni, block.__FIXME__l_struct_struct_OC_dim3_field0);
  __FIXME__call18 =
      _Z10num_blocksss(nl, block.__FIXME__l_struct_struct_OC_dim3_field1);
  ...
  memcpy(((uint8_t *)(&__FIXME__agg_2e_tmp20_2e_coerce)),
         ((uint8_t *)(&__FIXME__agg_2e_tmp20)), 12);
  memcpy(((uint8_t *)(&__FIXME__agg_2e_tmp21_2e_coerce)),
         ((uint8_t *)(&__FIXME__agg_2e_tmp21)), 12);
#pragma omp parallel for collapse(2)
  for (int32_t i = 0; i < __FIXME__call13; i = i + 1) {
    ...
    for (int32_t j = 0; j < __FIXME__call18; j = j + 1) {
      ...
      for (int32_t k = 0; k < 8; k = k + 1) {
        ...
        for (int32_t l = 0; l < 32; l = l + 1) {
          _Z23kernel_D_plus_tmp_mul_CiiiiddPdS_S_S_S__OC_2(
              ni, nj, nk, nl, alpha, beta, tmp, A, B, C, D, __FIXME__call13,
              __FIXME__call18, 1, __FIXME__div, 32, 1, i, j, 0, k, l, 0);
        }
      }
    }
  }
...
void _Z14kernel_A_mul_BiiiiddPdS_S_S_S__OC_1(
    uint32_t ni, uint32_t nj, uint32_t nk, uint32_t nl, double alpha,
    double beta, double *tmp, double *A, double *B, double *C, double *D,
    ...
    uint32_t __FIXME__threadIdx_2e_y, uint32_t __FIXME__threadIdx_2e_z) {
  int32_t i;
  int32_t j;
  int64_t k;
  double dot;
