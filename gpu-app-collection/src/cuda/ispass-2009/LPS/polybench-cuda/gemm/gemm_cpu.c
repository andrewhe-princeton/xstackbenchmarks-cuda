...
//YEBIN: this point in function printer
  ...
  __FIXME__call = _ZL10num_blocksii(ni, block.__FIXME__l_struct_struct_OC_dim3_field0);
  __FIXME__call1 = _ZL10num_blocksii(nj, block.__FIXME__l_struct_struct_OC_dim3_field1);
