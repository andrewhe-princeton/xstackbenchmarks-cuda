...
entry:
  ...
  call void @llvm.dbg.declare(metadata double* %dot, metadata !757, metadata !DIExpression()), !dbg !758
  store double 0.000000e+00, double* %dot, align 8, !dbg !758
  %6 = load i32, i32* %i, align 4, !dbg !759
  %7 = load i32, i32* %ni.addr, align 4, !dbg !761
  %cmp = icmp slt i32 %6, %7, !dbg !762
  br i1 %cmp, label %land.lhs.true, label %if.end, !dbg !763

land.lhs.true:                                    ; preds = %entry
  %8 = load i32, i32* %j, align 4, !dbg !764
  %9 = load i32, i32* %nj.addr, align 4, !dbg !765
  %cmp8 = icmp slt i32 %8, %9, !dbg !766
  br i1 %cmp8, label %if.then, label %if.end, !dbg !767

if.then:                                          ; preds = %land.lhs.true
  %10 = load double*, double** %C.addr, align 8, !dbg !768
  %11 = load i32, i32* %i, align 4, !dbg !770
  %12 = load i32, i32* %nj.addr, align 4, !dbg !771
  %mul9 = mul nsw i32 %11, %12, !dbg !772
  %13 = load i32, i32* %j, align 4, !dbg !773
  %add10 = add nsw i32 %mul9, %13, !dbg !774
  %idxprom = sext i32 %add10 to i64, !dbg !768
  %arrayidx = getelementptr inbounds double, double* %10, i64 %idxprom, !dbg !768
  %14 = load double, double* %arrayidx, align 8, !dbg !768
  %15 = load double, double* %beta.addr, align 8, !dbg !775
  %mul11 = fmul contract double %14, %15, !dbg !776
  store double %mul11, double* %dot, align 8, !dbg !777
  store i32 0, i32* %k, align 4, !dbg !778
  br label %for.cond, !dbg !780

for.cond:                                         ; preds = %for.inc, %if.then
  %16 = load i32, i32* %k, align 4, !dbg !781
  %17 = load i32, i32* %nk.addr, align 4, !dbg !783
  %cmp12 = icmp slt i32 %16, %17, !dbg !784
  br i1 %cmp12, label %for.body, label %for.end, !dbg !785

for.body:                                         ; preds = %for.cond
  %18 = load double, double* %alpha.addr, align 8, !dbg !786
  %19 = load double*, double** %A.addr, align 8, !dbg !787
  %20 = load i32, i32* %i, align 4, !dbg !788
  %21 = load i32, i32* %nk.addr, align 4, !dbg !789
  %mul13 = mul nsw i32 %20, %21, !dbg !790
  %22 = load i32, i32* %k, align 4, !dbg !791
  %add14 = add nsw i32 %mul13, %22, !dbg !792
  %idxprom15 = sext i32 %add14 to i64, !dbg !787
  %arrayidx16 = getelementptr inbounds double, double* %19, i64 %idxprom15, !dbg !787
  %23 = load double, double* %arrayidx16, align 8, !dbg !787
  %mul17 = fmul contract double %18, %23, !dbg !793
  %24 = load double*, double** %B.addr, align 8, !dbg !794
  %25 = load i32, i32* %k, align 4, !dbg !795
  %26 = load i32, i32* %nj.addr, align 4, !dbg !796
  %mul18 = mul nsw i32 %25, %26, !dbg !797
  %27 = load i32, i32* %j, align 4, !dbg !798
  %add19 = add nsw i32 %mul18, %27, !dbg !799
  %idxprom20 = sext i32 %add19 to i64, !dbg !794
  %arrayidx21 = getelementptr inbounds double, double* %24, i64 %idxprom20, !dbg !794
  %28 = load double, double* %arrayidx21, align 8, !dbg !794
  %mul22 = fmul contract double %mul17, %28, !dbg !800
  %29 = load double, double* %dot, align 8, !dbg !801
  %add23 = fadd contract double %29, %mul22, !dbg !801
  store double %add23, double* %dot, align 8, !dbg !801
  br label %for.inc, !dbg !802

for.inc:                                          ; preds = %for.body
  %30 = load i32, i32* %k, align 4, !dbg !803
  %inc = add nsw i32 %30, 1, !dbg !803
  store i32 %inc, i32* %k, align 4, !dbg !803
  br label %for.cond, !dbg !804, !llvm.loop !805

for.end:                                          ; preds = %for.cond
  %31 = load double, double* %dot, align 8, !dbg !807
  %32 = load double*, double** %C.addr, align 8, !dbg !808
  %33 = load i32, i32* %i, align 4, !dbg !809
  %34 = load i32, i32* %nj.addr, align 4, !dbg !810
  %mul24 = mul nsw i32 %33, %34, !dbg !811
  %35 = load i32, i32* %j, align 4, !dbg !812
  %add25 = add nsw i32 %mul24, %35, !dbg !813
  %idxprom26 = sext i32 %add25 to i64, !dbg !808
  %arrayidx27 = getelementptr inbounds double, double* %32, i64 %idxprom26, !dbg !808
  store double %31, double* %arrayidx27, align 8, !dbg !814
...
!6 = !DIFile(filename: "gemm.cu", directory: "/u/ah7226/xstack-benchmark/polybench-cuda/gemm")
!7 = !{}
...
!605 = !{!"clang version 9.0.0 (https://github.com/yebinchon/llvm-project a1efa594106d738d0b74c9e4e2b9b779eb8b7d25)"}
!606 = !{i32 1, i32 2}
...
!630 = !DIFile(filename: "/scratch/ah7226/install-9-cudafe/lib/clang/9.0.0/include/__clang_cuda_builtin_vars.h", directory: "")
...
!757 = !DILocalVariable(name: "dot", scope: !607, file: !6, line: 21, type: !156)
!758 = !DILocation(line: 21, column: 10, scope: !607)
!759 = !DILocation(line: 24, column: 7, scope: !760)
!760 = distinct !DILexicalBlock(scope: !607, file: !6, line: 24, column: 7)
!761 = !DILocation(line: 24, column: 11, scope: !760)
!762 = !DILocation(line: 24, column: 9, scope: !760)
!763 = !DILocation(line: 24, column: 14, scope: !760)
!764 = !DILocation(line: 24, column: 17, scope: !760)
!765 = !DILocation(line: 24, column: 21, scope: !760)
!766 = !DILocation(line: 24, column: 19, scope: !760)
!767 = !DILocation(line: 24, column: 7, scope: !607)
!768 = !DILocation(line: 25, column: 11, scope: !769)
!769 = distinct !DILexicalBlock(scope: !760, file: !6, line: 24, column: 25)
